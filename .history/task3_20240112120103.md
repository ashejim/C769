...
As a convenience to the evaluators, you may copy content from your [Task 2 section D](task2:D) labeling it as *Original Environment*, and then add new material (a paragraph typically suffices) describing how the project changed the ori
