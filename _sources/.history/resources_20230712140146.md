...
These examples are more on-par with average passing tasks. Use them as a guideline (but just a guideline; every project is different) for what evaluators accept in fulfillment of the requirements.  
