...
```{warning}
Be aware that task 2 and 3 submissions can take the full 3 days to be evaluated. If approaching the end of your term, don't wait on task 2 to start task 3, submit task 3 early enough to have it submitted   
```
