...
Step 2 provides a detailed implementation plan of what is outlined in section A2. Relate it to a "standard" methodology if using a less known methodology.
