...
<blockquote>
  ...
  <table style="width: 100%;">
    <tbody>
        <tr>
            <th style="width: 24.3857%;">
                <div style="text-align: center;"><strong>Goals&nbsp;</strong></div>
            </th>
            <th style="width: 25.4299%;">
                <div style="text-align: center;"><strong>Met</strong></div>
            </th>
            <th style="width: 25.0615%;">
                <div style="text-align: center;"><strong>Objectives</strong></div>
            </th>
            <th style="width: 25.0000%;">
                <div style="text-align: center;"><strong>Met</strong></div>
            </th>
        </tr>
        <tr>
            <td style="width: 24.3857%;" rowspan="2"><strong>1.</strong> goal 1</td>
            <td style="width: 25.4299%;" rowspan="2">
                <div style="text-align: center;">Yes</div>
            </td>
            <td style="width: 25.0615%;"><strong>1. a.&nbsp;</strong>Objective 1.a</td>
            <td style="width: 25.0000%;">
                <div style="text-align: center;">Yes</div>
            </td>
        </tr>
        <tr>
            <td style="width: 25.0615%;"><strong>1. b.&nbsp;</strong>Objective 1.b</td>
            <td style="width: 25.0000%;">
                <div style="text-align: center;">No</div>
            </td>
        </tr>
        <tr>
            <td style="width: 24.3857%;" rowspan="3"><strong>2.</strong> goal 2&nbsp;</td>
            <td style="width: 25.4299%;" rowspan="3">
                <div style="text-align: center;">Yes</div>
            </td>
            <td style="width: 25.0615%;"><strong>2.a.&nbsp;</strong>Objective 2.a</td>
            <td style="width: 25.0000%;">
                <div style="text-align: center;">Yes</div>
            </td>
        </tr>
