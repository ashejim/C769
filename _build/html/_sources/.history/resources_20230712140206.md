...
These examples are more on-par with average passing tasks. Use them as guidelines (but just guidelines; every project is different) for what evaluators accept in fulfillment of the requirements.  
