...
1. Provide a table outlining project goals, objectives, and deliverables.
   |Goal |Supporting Objectives  | Deliverables enabling project objectives|
   --- | --- | ---|
   | | |
   | | | |
   | | | |
...
At minimum, there should be one goal, each goal should have one objectives, and each objective have one deliverbale.
